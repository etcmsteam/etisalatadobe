...
public @interface GoogleMapsConfiguration {
  ...
  @AttributeDefinition(name = "google captcha v2", description = "Google Captcha V2 site key")
  String getGoogleCaptchaV2();

  @AttributeDefinition(name = "google captcha v3", description = "Google Captcha V3 site key")
  String getGoogleCaptchaV3();

  @AttributeDefinition(name = "google captcha invisible", description = "Google Captcha Invisible site key")
  String getGoogleCaptchaInvisible();
