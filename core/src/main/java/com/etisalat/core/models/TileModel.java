...
public class TileModel {
  ...
  public String getTileBoxContainerLayout() {
	...
	if (null != tileContainerResource && (tileContainerResource.getResourceType()
			.equals(PageConstants.TILE_CONTAINER_RESOURCETYPE)
			|| tileContainerResource.getResourceType().equals(PageConstants.ENTERPRISE_TILE_CONTAINER_RESOURCETYPE)
