...
module.exports = {
  ...
  entry: {
    ...
    futurenow: SOURCE_ROOT + '/futurenow/main.js',
    ...
    eandenterprise: SOURCE_ROOT + '/eandenterprise/main.js',
  },
  output: {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      ...
      { from: path.resolve(__dirname, SOURCE_ROOT + '/eandenterprise/resources'), to: './clientlib-eandenterprise/' },
    ]),
  ],
  stats: {
    assetsSort: 'chunks',
