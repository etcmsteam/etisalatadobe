...
(function (factory) {
  ...
  return (function () {
    ...
    if (document.querySelector('[name="firstName"]') !== null) {
      ...
      {
        document.querySelector('[name="firstName"]').parentElement.innerHTML +=
          "<label>" + document.querySelector('[name="firstName"]').placeholder + "</label>";
    ...
    if (document.querySelector('[name="companyName"]') !== null) {
      ...
      {
        document.querySelector('[name="companyName"]').parentElement.innerHTML +=
          "<label>" + document.querySelector('[name="companyName"]').placeholder + "</label>";
    ...
    if (document.querySelector('[name="phoneNumber"]') !== null) {
      ...
      {
        document.querySelector('[name="phoneNumber"]').parentElement.innerHTML +=
          "<label>" + document.querySelector('[name="phoneNumber"]').placeholder + "</label>";
    ...
    if (input !== null) {
      ...
      $(document).on("keyup", "#phoneNumber", function (e) {
        if ((e.which === 9 && this.elementValue(element) === "") || $.inArray(e.keyCode, excludedKeys) !== -1) {
          return;
        } else {
            ...
            if (phonevalid(inputVal) && inputVal.length == 10) {
              ...
              if (errorMsg) {
                ...
                if ($("#phoneNumber").parent().parent().hasClass("has-error-fields")) {
                  $("#phoneNumber").parent().find(".alert-label").remove();
                  $("#phoneNumber").parent().find(".alert-icon").remove();
                  document.querySelector("#phoneNumber").parentElement.innerHTML +=
                    '<div id="phoneNumber-error" class="has-error alert-label">' + errorMsg + "</div>";
