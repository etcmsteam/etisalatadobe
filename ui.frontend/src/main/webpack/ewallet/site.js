        ...
        function resultItemTemplateList(resultData) {
            ...
            if (items != null) {
                ...
                $.each(items, function (key, val) {
                    ...
                    data-type="store">
                   <h5>${val.name} <label>${val.distance}</label></h5><b>${val.address ? val.address : ''}</b>
        ...
        */
            ...
            $("#storessuggestion").autocomplete({
                ...
                .autocomplete("instance")._renderItem = function (ul, item) {
                    ...
                    return $("<li>")
                        ...
                        .append("<div> <div class='ui-menu-item-title'>" + item.label +
                            "</div><div class='ui-menu-item-desc'>" + item.address + "</div></div>")
                        .appendTo(ul);
                };
        }
        ...
        function renderStores(storeLocator) {
            ...
            $.each(storeLocatorData, function (key, data) {
                ...
                var contentString =
                    ' <div id="content-' + data.id + '" class="more-details-box"> ' +
                    ' <div class="box-container"> ' +
                    ' <div class="col-md-12 col-sm-12 col-lg-12 "> ' +
                    ' <div class="box-section"> ' +
                    ' <div class="header-name"> ' +
                    ' <h4>' + data.name + '<label>' + data.distance + '</label></h4> ' +
                    ' <p class="dynamic-value">' + data.address + '</p> ' +

                    //  ' <p class="dynamic-value">' + data.city + ' - ' + data.country + '</p> ' +
                    ' </div> ' +

                    ' <div class="box-section-footer"> ' +
                    (data.phoneNumber ? ' <div class="contact-info-no"> ' +
                        ' <p><span class="dynamic-value">' + data.phoneNumber + '</span></p> ' +
                        ' </div> ' : '') +
