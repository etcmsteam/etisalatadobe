...
(function (factory) {
  ...
  return (function () {
    ...
    var utilPath =
      "https://cdn.jsdelivr.net/npm/intl-tel-input@15.0.2/build/js/utils.js";
    //var utilPath = "\\ui.frontend\src\main\webpack\etisalat\intlTelIUtils.js";
    var allCountries = [
      ["Afghanistan", "af", "93"],
      ["Albania", "al", "355"],
      ["Algeria", "dz", "213"],
    ...
    if (ele !== null) {
      ...
      a.setAttribute("class", "selected-item");
      ...
      for (j = 1; j < ll; j++) {
        ...
        d.addEventListener("click", function (e) {
          ...
          var y, i, k, s, h, sl, yl;
          s =
            this.parentNode.parentNode.parentElement.getElementsByTagName(
              "select"
            )[0];
          sl = s.length;
    ...
    if (ele1 !== null) {
      ...
      a.innerHTML =
        selElmntCounty.options[selElmntCounty.selectedIndex].innerHTML;
    ...
    if (selElmntAboutUs !== null) {
      ...
      a.setAttribute("class", "select-selected");
      a.innerHTML =
        selElmntAboutUs.options[selElmntAboutUs.selectedIndex].innerHTML;
    ...
    var urlString;
    var fieldRequired =
      '<div id="error" class="has-error alert-label">This field is required.</div>';
    var fieldError =
      '<div id="fullName-error" class="has-error alert-label">Letters, and spaces only please.</div>';
    ...
    if (input !== null) {
      ...
      var labelHtml = document
        .querySelector("#phone1")
        .parentElement.parentElement.getElementsByTagName("label")[0];
      document
        .querySelector("#phone1")
        .parentElement.parentElement.getElementsByTagName("label")[0]
        .remove();
      ...
      $(document).on("keyup", "#phone1", function (element) {
        ...
        if ($("#phone1").val() == "") {
          ...
          $("#phone1")
            .parent()
            .addClass("has-error-fields")
            .removeClass("is-valid");
          alertIcon = "";
          alertIcon = contentString;
          if ($("#phone1").parent().hasClass("has-error-fields")) {
            document.querySelector("#phone1").parentElement.innerHTML +=
              fieldRequired;
            document.querySelector("#phone1").parentElement.innerHTML +=
              alertIcon;
            $("#phone1").val(inputVal);
          ...
          if ($("#phone1").val().trim()) {
            ...
            if (phonevalid(inputVal) && inputVal.length == 10) {
              ...
              if (errorMsg) {
                ...
                if (
                  $("#phone1").parent().parent().hasClass("has-error-fields")
                ) {
                  $("#phone1").parent().find(".alert-label").remove();
                  $("#phone1").parent().find(".alert-icon").remove();
                  document.querySelector("#phone1").parentElement.innerHTML +=
                    '<div id="phone1-error" class="has-error alert-label">' +
                    errorMsg +
                    "</div>";
    ...
    if (input2 !== null) {
      ...
      var labelContactNumHtml = document
        .querySelector("#contactNumber")
        .parentElement.parentElement.getElementsByTagName("label")[0];
      document
        .querySelector("#contactNumber")
        .parentElement.parentElement.getElementsByTagName("label")[0]
      ...
      document
        .querySelector("#contactNumber")
        .parentElement.append(labelContactNumHtml);
      iti.selectedFlag.children[0].textContent =
      ...
      var fieldRequired =
        '<div id="errorRequired" class="has-error alert-label">This field is required.</div>';
      var errorMsg;
      ...
      $(document).on("keyup", "#contactNumber", function (element) {
        ...
        if ($("#contactNumber").val() == "") {
          ...
          if ($("#contactNumber").parent().hasClass("has-error-fields")) {
            document.querySelector("#contactNumber").parentElement.innerHTML +=
              fieldRequired;
            document.querySelector("#contactNumber").parentElement.innerHTML +=
              alertIcon;
              ...
              if (errorMsg) {
                ...
                if ($("#contactNumber").parent().hasClass("has-error-fields")) {
                  ...
                  document.querySelector(
                    ...
                    '<div id="contactNumber-error" class="has-error alert-label">' +
                    errorMsg +
                    "</div>";
                  //document.querySelector('#phone1').parentElement.innerHTML += alertIcon;
                  $("#contactNumber").val(inputVal);
    ...
    if (input3 !== null) {
      ...
      $(document).on("keyup", "#mobileNumber", function (element) {
        ...
        if ($("#mobileNumber").val() == "") {
          $("#mobileNumber").parent().parent().removeClass("has-error-fields"); // remove it
          $("#mobileNumber").parent().next(".alert-label").remove();
          ...
          alertIcon = "";
          alertIcon = contentString;
          if ($("#mobileNumber").parent().hasClass("has-error-fields")) {
            document.querySelector("#mobileNumber").parentElement.innerHTML +=
              fieldRequired;
            document.querySelector("#mobileNumber").parentElement.innerHTML +=
              alertIcon;
      ...
      if (
        ...
        if ($("#companyName").val() == "") {
          ...
          if ($("#companyName").parent().hasClass("has-error-fields")) {
            document.querySelector("#companyName").parentElement.innerHTML +=
              fieldRequired;
            document.querySelector("#companyName").parentElement.innerHTML +=
              alertIcon;
      ...
      if (
        ...
        if ($("#url").val() == "") {
          ...
          if ($("#url").parent().hasClass("has-error-fields")) {
            document.querySelector("#url").parentElement.innerHTML +=
              fieldRequired;
        ...
        if (!urlvalid($("#url").val())) {
          ...
          if ($("#url").parent().hasClass("has-error-fields")) {
            document.querySelector("#url").parentElement.innerHTML +=
              '<div id="url-error" class="has-error alert-label">Please Enter A Valid URL</div>';
            document.querySelector("#url").parentElement.innerHTML += alertIcon;
            $("#url").val(inputVal);
            $("#url").keyup();
          }
      ...
      if (
        ...
        if ($("#fullName").val() == "") {
          ...
          if ($("#fullName").parent().hasClass("has-error-fields")) {
            document.querySelector("#fullName").parentElement.innerHTML +=
              fieldRequired;
            document.querySelector("#fullName").parentElement.innerHTML +=
              alertIcon;
      ...
      if (
        ...
        if ($("#firstName").val() == "") {
          ...
          if ($("#firstName").parent().hasClass("has-error-fields")) {
            document.querySelector("#firstName").parentElement.innerHTML +=
              fieldRequired;
            document.querySelector("#firstName").parentElement.innerHTML +=
              alertIcon;
      ...
      if (
        ...
        if ($("#lastName").val() == "") {
          ...
          if ($("#lastName").parent().hasClass("has-error-fields")) {
            document.querySelector("#lastName").parentElement.innerHTML +=
              fieldRequired;
            document.querySelector("#lastName").parentElement.innerHTML +=
              alertIcon;
      ...
      if (
        ...
        if ($("#emailAddress").val() == "") {
          ...
          if ($("#emailAddress").parent().hasClass("has-error-fields")) {
            document.querySelector("#emailAddress").parentElement.innerHTML +=
              fieldRequired;
            document.querySelector("#emailAddress").parentElement.innerHTML +=
              alertIcon;
        ...
        if (!email2(inputVal)) {
          ...
          if ($("#emailAddress").parent().hasClass("has-error-fields")) {
            document.querySelector("#emailAddress").parentElement.innerHTML +=
              '<div id="emailAddress-error" class="has-error alert-label">Please enter a valid email address</div>';
            document.querySelector("#emailAddress").parentElement.innerHTML +=
              alertIcon;
            $("#emailAddress").val(inputVal);
            $("#emailAddress").keyup();
    ...
    $(document).on("keyup", "#justification", function (e) {
      ...
      if ($("#justification").val() == "") {
        ...
        if ($("#justification").parent().hasClass("has-error-fields")) {
          document.querySelector("#justification").parentElement.innerHTML +=
            fieldRequired;
          document.querySelector("#justification").parentElement.innerHTML +=
            alertIcon;
          $("#justification").val(inputVal);
          $("#justification").keyup();
        }
        return;
      }
    ...
    $(document).on("keyup", "#description", function (e) {
      ...
      $("#description").parent().find(".alert-label").remove();
      ...
      if ($("#description").val() == "") {
        ...
        if ($("#description").parent().hasClass("has-error-fields")) {
          document.querySelector("#description").parentElement.innerHTML +=
            fieldRequired;
          document.querySelector("#description").parentElement.innerHTML +=
            alertIcon;
      ...
      if ($("#description").val()) {
        ...
        div = fieldRequired;
        if ($("#description").parent().hasClass("has-error-fields")) {
          document.querySelector("#description").parentElement.innerHTML += div;
          document.querySelector("#description").parentElement.innerHTML +=
            alertIcon;
        }
    ...
    $(document).on("keyup", "#accountNumber", function (e) {
      ...
      if ($("#accountNumber").val() == "") {
        ...
        if ($("#accountNumber").parent().hasClass("has-error-fields")) {
          document.querySelector("#accountNumber").parentElement.innerHTML +=
            fieldRequired;
          document.querySelector("#accountNumber").parentElement.innerHTML +=
            alertIcon;
          $("#accountNumber").val(inputVal);
          $("#accountNumber").keyup();
        }
        return;
      }
    ...
    $(document).on("keyup", "#designation", function (e) {
      ...
      if ($("#designation").val() == "") {
        ...
        if ($("#designation").parent().hasClass("has-error-fields")) {
          document.querySelector("#designation").parentElement.innerHTML +=
            fieldRequired;
          document.querySelector("#designation").parentElement.innerHTML +=
            alertIcon;
          $("#designation").val(inputVal);
          $("#designation").keyup();
        }
        return;
      }
      if ($("#designation").val()) {
        ...
        if ($("#designation").parent().hasClass("has-error-fields")) {
          ...
          document.querySelector("#designation").parentElement.innerHTML += div;
          document.querySelector("#designation").parentElement.innerHTML +=
            alertIcon;
        }
      }
    ...
    $(".cmp-form-button").on("click", function () {
      ...
      if (!$("#fullName").val()) {
        $("#fullName")
          ...
          .removeClass("is-valid")
          .addClass("has-error-fields");
        if ($("#fullName").parent().next(".alert-label").length == 0) {
      ...
      if (!$("#emailAddress").val()) {
        $("#emailAddress")
          ...
          .removeClass("is-valid")
          .addClass("has-error-fields");
        if ($("#emailAddress").parent().next(".alert-label").length == 0) {
          // only add if not added
          ...
          if (
            $("#emailAddress").parent().hasClass("has-error-fields") == false
          ) {
            $("#emailAddress")
              .parent()
              .removeClass("has-error-fields")
      ...
      if (!$("#companyName").val() && $("#companyName").val() !== undefined) {
        ...
        alertIcon = "";
        alertIcon = contentString;
        if ($("#companyName").parent().next(".alert-label").length == 0) {
          // only add if not added
      ...
      if (!$("#description").val() && $("#description").val() !== undefined) {
        if ($("#description").parent().next(".alert-label").length == 0) {
          // only add if not added
          $("#description").parent().next(".alert-label").remove();
          $("#description")
            .parent()
      ...
      if (
        !$("#justification").val() &&
        $("#justification").val() !== undefined
      ) {
        $("#justification").parent().next(".alert-label").remove();
        if ($("#justification").parent().next(".alert-label").length == 0) {
          // only add if not added
          $("#justification")
            .parent()
            .removeClass("is-valid")
        ...
        if (
          $("#justification").parent().hasClass("has-error-fields") == false
        ) {
          $("#justification")
            .parent()
            .removeClass("has-error-fields")
      ...
      if (!$("#select2-selection__rendered").val()) {
        if (
          $("#select2-selection__rendered").parent().next(".alert-label")
            .length == 0
        ) {
          // only add if not added
          $("#select2-selection__rendered")
      ...
      if (!$("#firstName").val()) {
        $("#firstName")
          ...
          .removeClass("has-error-fields")
          .addClass("has-error-fields");
        if ($("#firstName").parent().next(".alert-label").length == 0) {
          // only add if not added
      ...
      if (!$("#lastName").val()) {
        $("#lastName")
          ...
          .removeClass("is-valid")
          .addClass("has-error-fields");
        if ($("#lastName").parent().next(".alert-label").length == 0) {
          // only add if not added
      ...
      if (!$("#url").val()) {
        ...
        if ($("#url").parent().next(".alert-label").length == 0) {
          // only add if not added
      ...
      if (!$("#phone1").val() || $("#phone1").val() == "") {
        ...
        if (
          $("#phone1").parent().parent().hasClass("has-error-fields") == false
        ) {
          $("#phone1")
            .parent()
            .removeClass("has-error-fields")
      ...
      if (!$("#mobileNumber").val() || $("#mobileNumber").val() == "") {
        ...
        if (
          $("#mobileNumber").parent().parent().hasClass("has-error-fields") ==
          false
        ) {
          $("#mobileNumber")
            .parent()
      ...
      if (!$("#contactNumber").val() || $("#contactNumber").val() == "") {
        ...
        if (
          $("#contactNumber").parent().parent().hasClass("has-error-fields")
        ) {
          $("#contactNumber").parent().find(".alert-label").remove();
          $("#contactNumber").parent().find(".alert-icon").remove();
          document.querySelector("#contactNumber").parentElement.innerHTML +=
      ...
      if (!$("#accountNumber").val()) {
        $("#accountNumber")
          ...
          .removeClass("has-error-fields")
          .addClass("has-error-fields");
        if ($("#accountNumber").parent().next(".alert-label").length == 0) {
          // only add if not added
        ...
        if (
          $("#accountNumber").parent().hasClass("has-error-fields") == false
        ) {
          $("#accountNumber")
            .parent()
            .removeClass("has-error-fields")
      ...
      if (
        ...
        $("#designation").val() !== undefined
      ) {
        $("#designation").parent().addClass("has-error-fields");
        alertIcon = "";
        alertIcon = contentString;
        if ($("#designation").parent().next(".alert-label").length == 0) {
          // only add if not added
          $("#designation").parent().after(div);
          ...
          if (
            $("#accountNumber")
              .parent()
              .parent()
              .hasClass("has-error-fields") == false
          ) {
            $("#accountNumber")
              .parent()
              .parent()
      ...
      if (!$("#select-hear-about-us").val()) {
        ...
        if (
          $("#select-hear-about-us").parent().next(".alert-label").length == 0
        ) {
          // only add if not added
    ...
    $('input[name="existingAccount"]').change(function () {
      if (this.value == "no") {
        $(".account-number")
          .removeClass("showBusiness")
          .addClass("hideBusiness");
      } else {
        $(".account-number")
          .removeClass("hideBusiness")
          .addClass("showBusiness");
      }
    });
    ...
    if (document.getElementById("select-hear-about-us") !== null) {
      setInputFilter(
        document.getElementById("select-hear-about-us"),
        function (value) {
          return /^-?\d*$/.test(value);
        }
      );
