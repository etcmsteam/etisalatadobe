...
(function (factory) {
    ...
    if (document.getElementById("accountNumber") !== null)
    {
        ...
        // of IE11
        //  var forEachProp;
        // forEachProp = function forEachProp(obj, callback) {
        ...
        // var forEachInstance;
        // forEachInstance = function forEachInstance(method) {
 ...
 ********************/
        ...
        var injectScript;
        // injectScript = function injectScript(path, handleSuccess, handleFailure) {
