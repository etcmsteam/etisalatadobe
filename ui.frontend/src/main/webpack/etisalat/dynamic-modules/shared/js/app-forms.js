...
export const APP_FORMS = () => {
   ...
   * -------------------------------------------------------------------------------
   */
  var svgAlertLabel = `<svg xmlns:xlink="http://www.w3.org/1999/xlink">
    <symbol id="alert-icon" viewBox="0 0 45 45">
      <path
        d="M21.322 25.937v-13.235c0-.588.469-1.057 1.058-1.057.589 0 1.058.468 1.058 1.057v13.235c0 .588-.469 1.057-1.058 1.057-.589.065-1.058-.468-1.058-1.057m2.296 5.768c0 .648-.529 1.176-1.178 1.176-.649 0-1.178-.528-1.178-1.176 0-.648.529-1.176 1.178-1.176.649 0 1.178.528 1.178 1.176m-1.118 11.117c-11.19 0-20.319-9.118-20.319-20.294s9.129-20.354 20.319-20.354 20.319 9.118 20.319 20.354c0 11.236-9.129 20.294-20.319 20.294m0-42.821c-12.428 0-22.5 10.06-22.5 22.473 0 12.413 10.072 22.527 22.5 22.527s22.5-10.12 22.5-22.473c0-12.413-10.072-22.527-22.5-22.527" />
    </symbol>
  <use xlink:href="#alert-icon"/>
  </svg>`;
  // var alertIcon = '<div class="alert-icon"><svg xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="#alert-icon"/></svg></div>';
  var alertIcon = `<div class="alert-icon">
    <svg xmlns:xlink="http://www.w3.org/1999/xlink">
      <symbol id="error-icon-red" viewBox="0 0 64 64">
        <defs></defs>
        <g id="icon_error" stroke="none" stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="round"
        stroke-linejoin="round">
        <g id="icon_error_red_64" stroke="#BE1218">
          <g id="@-Self-Care-/-Icon-/-Outline-/-Error-/-red">
          <path
            d="M59.9958503,31.5126196 C60.2643926,46.9726045 47.4634532,59.7271876 31.9999998,59.9956917 C16.5390919,60.2641958 4.27269159,47.9486362 4.00414931,32.4873787 C3.73560704,17.0273937 16.5378192,4.27281071 31.9999998,4.00430657 C47.4634532,3.73580243 59.727308,16.0564522 59.9958503,31.5126196 L59.9958503,31.5126196 Z"
            id="Line"></path>
