        $(document).ready(function () {
            ...
            // slider
            var $notifications = new Swiper('.digital-notifications-wrapper.multi-notifications .swiper-container', {
                direction: 'vertical',
                slidesPerView: 1,
                //effect: 'fade',
                autoplay: 5000,
            ...
            $('.digital-notifications-wrapper.bottom .noti-icon-dismis').off('click').on('click', 'a', function (e) {
                e.stopPropagation();
                e.preventDefault();
