...
export const ACCESSORIES_CARDS = () => {
  ...
  function initAccessorySwiper() {
    $(document)
      .find(".accessories-wrapper.with-slider")
      .each(function (index) {
        ...
        var $accessoriesSlider = swiperInit(
          ".card-slider" + index + " .swiper-container",
          swiperOptions($slider, ".next.right" + index, ".prev.left" + index, 2.2, 4, 4, 6, 7),
        );
  ...
  function initRecommendationSwiper() {
    $(document)
      .find(".eti-recommendation-wrapper.with-slider")
      .each(function (index) {
        ...
        $slider.removeClass("remove-controls");
        var $accessoriesSlider = swiperInit(
          ".eti-card-slider" + index + " .swiper-container",
          swiperOptions($slider, ".next.eti-right" + index, ".prev.eti-left" + index, 2.2, 3, 3, 4, 5),
        );
  ...
  function initBigRecommendationSwiper() {
    $(document)
      .find(".eti-recommendation-big-card.with-slider")
      .each(function (index) {
        ...
        $slider.addClass("remove-controls");
        $slider.removeClass("remove-controls");
        var $accessoriesBigCardSlider = swiperInit(
          ".eti-big-card-slider" + index + " .swiper-container",
          swiperOptions($slider, ".next.eti-big-right" + index, ".prev.eti-big-left" + index, 2.2, 2.5, 2.5, 3, 3),
        );
  ...
  function initBrandsLogo() {
    $(document)
      ...
      .each(function (index) {
        ...
        $slider.removeClass("remove-controls");
        var $accessoriesBigCardSlider = swiperInit(
          ".brands-slider" + index + " .swiper-container",
          swiperOptions($slider, ".next.logo-right" + index, ".prev.logo-left" + index, 3.5, 5, 6, 9, 9),
        );
