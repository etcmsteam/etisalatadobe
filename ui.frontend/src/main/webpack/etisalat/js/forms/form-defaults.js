 ...
 */
var svgAlertLabel =
  '<svg xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="#alert-icon"/></svg>';
...
function setValidationDefaults() {
  ...
  $.validator.addMethod(
    ...
    function (value, element) {
      return (
        ...
        /^[a-zA-Z\u0600-\u0660-\u0669\u06ff\u0750-\u077f\ufb50-\ufbc1\ufbd3-\ufd3f\ufd50-\ufd8f\ufd92-\ufdc7\ufe70-\ufefc\uFDF0-\uFDFD\s]+$/i.test(
          value
        )
      );
    },
  ...
  $.validator.addMethod(
    ...
    function (value, element) {
      return (
        this.optional(element) || /^[^\/|\-][A-Za-z0-9/\-\s]+$/i.test(value)
      );
    },
  ...
  $.validator.addMethod(
    ...
    function (value, element) {
      return (
        this.optional(element) ||
        /^(?=.*[A-Za-z]{2})(?=.*\d{2})[A-Za-z\d]{8,}$/i.test(value)
      );
    },
  ...
  $.validator.addMethod(
    ...
    function (value, element) {
      return (
        this.optional(element) ||
        /^(?=.*[A-Za-z]{1})(?=.*\d{1})[A-Za-z\d]{8,}$/i.test(value)
      );
    },
  ...
  $.validator.addMethod(
    ...
    function (value, element) {
      return (
        this.optional(element) ||
        /^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])([a-zA-Z0-9@._-]{5,248})/.test(value)
      );
    },
    "Password not valid"
  );
  ...
  $.validator.addMethod(
    ...
    function (value, element) {
      return (
        this.optional(element) ||
        /^(?=.*[0-9])(?=.*[a-z])[a-zA-Z0-9_@\-]{5,248}$/.test(value)
      );
    },
    "Password invalid"
  );
  ...
  $.validator.addMethod(
    ...
    function (value, element) {
      return (
        this.optional(element) ||
        /^(?=.*[0-9a-zA-Z])([a-zA-Z0-9@._-]{5,100})$/.test(value)
      );
    },
    "Username not valid"
  );
