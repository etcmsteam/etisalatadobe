...
(function () {
  ...
  function initSwiper() {
    ...
    $(document)
      .find(".product-grid-text-section.plans")
      .each(function (index) {
    ...
    if ($(".smart-home-elife-slider").length) {
      $(document)
        ...
        .each(function (index) {
          ...
          var $carouselSliderSmartHome = swiperInit(
            ".slider" + index + " .swiper-container",
            swiperOptions($slider, ".table-swiper-button-next.plansRightElife" + index, ".table-swiper-button-prev.plansLeftElife" + index, 1, 2, 2, 2, 2),
          );
    ...
    $(document)
      .find(".product-grid-text-section.addons")
      .each(function (index) {
