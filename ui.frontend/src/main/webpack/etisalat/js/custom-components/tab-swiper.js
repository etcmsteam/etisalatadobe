  ...
  initSwiper = function () {
    ...
    $(document)
      ...
      .each(function (index) {
        ...
        const isChanneltabs = $swiperTabsParent.parents().hasClass("cmp-tab-wst-channellist");
        ...
        var edcSwiperWithArrows = swiperInit(".edc-swiper-tabs" + index + " .swiper-container", {
          ...
          breakpoints: {
            540: {
              slidesPerView: istabs ? "auto" : isChanneltabs ? "auto" : 3,
            },
            768: {
              slidesPerView: istabs ? "auto" : isChanneltabs ? "auto" : 4,
            },
            1024: {
              slidesPerView: istabs ? "auto" : isChanneltabs ? 'auto': 4,
            },
